      ...
      >
        ...
        >
          <div className="h-full flex flex-col p-3 overflow-y-auto">
            ...
            {!isCollapsed && (
              <div className="mt-1 text-xs text-zinc-500">
                Varyn v{packageJson.version} - <button onClick={() => setShowChangelog(true)} className="text-xs text-zinc-500 hover:text-primary">Changelog</button>
              </div>
            )}		
          </div>
            ...
            <div className="fixed inset-0 flex items-center justify-center p-4">
              <Dialog.Panel className="mx-auto max-w-lg rounded-lg bg-white dark:bg-zinc-800 p-6 shadow-xl transition-all duration-300">
				...
				<div className="mb-4">
				  ...
				  <p className="text-sm text-zinc-500 dark:text-zinc-400">
					© 2025 postedDevelopment — All rights reserved.
				  </p>
				</div>
